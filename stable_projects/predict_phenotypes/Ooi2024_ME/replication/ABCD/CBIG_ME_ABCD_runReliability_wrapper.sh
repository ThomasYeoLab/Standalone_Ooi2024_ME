...
$script_dir/CBIG_ME_ABCD_schedule_interpretation.sh full BWA
$script_dir/CBIG_ME_ABCD_schedule_interpretation.sh full Haufe
### run reliability analysis for randomized run order
$script_dir/CBIG_ME_ABCD_schedule_interpretation.sh random BWA
$script_dir/CBIG_ME_ABCD_schedule_interpretation.sh random Haufe
