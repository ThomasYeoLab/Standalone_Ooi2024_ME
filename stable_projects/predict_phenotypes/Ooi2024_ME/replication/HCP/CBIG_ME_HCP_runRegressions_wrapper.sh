...
$script_dir/CBIG_ME_HCP_schedule_regression.sh KRR full
$script_dir/CBIG_ME_HCP_schedule_regression.sh LRR full
## run KRR 419x419-resolution FC matrices with "no_censoring", "uncensored_only" settings
$script_dir/CBIG_ME_HCP_schedule_regression.sh KRR no_censoring
$script_dir/CBIG_ME_HCP_schedule_regression.sh KRR uncensored_only
## run KRR 419x419-resolution FC matrices with randomized run order
$script_dir/CBIG_ME_HCP_schedule_regression.sh KRR random
## run KRR for 1019x1019-resolution FC matrices using original run order
$script_dir/CBIG_ME_HCP_schedule_regression.sh KRR full_1000parcels
## run KRR 419x19 FC matrices subcortical connections using original run order
$script_dir/CBIG_ME_HCP_schedule_regression.sh KRR_sc full
## run KRR 419x419-resolution FC matrices with equal contribution from each day
$script_dir/CBIG_ME_HCP_schedule_regression.sh KRR full_mixdays
...
$script_dir/CBIG_ME_HCP_schedule_regression.sh KRR_sh full
$script_dir/CBIG_ME_HCP_schedule_regression.sh KRR_sh random
