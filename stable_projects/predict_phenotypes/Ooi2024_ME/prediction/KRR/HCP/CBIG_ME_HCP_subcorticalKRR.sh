...
#
# EXAMPLE: 
#    CBIG_ME_HCP_subcorticalKRR.sh 1 58 full
#
...
mkdir -p $projectdir/output/${vers}_sc/seed_${seed}/logs
LF="$projectdir/output/${vers}_sc/seed_${seed}/logs/${outstem}_${seed}.log"
...
matlab -nodesktop -nosplash -nodisplay -r " try addpath('$scriptdir'); CBIG_ME_HCP_subcorticalKRR( \
