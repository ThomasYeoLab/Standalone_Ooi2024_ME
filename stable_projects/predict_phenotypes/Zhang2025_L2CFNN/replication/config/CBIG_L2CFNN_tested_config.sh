#!/bin/sh
# Last successfully run on May 10, 2025 with git repository version 
# v0.32.0-Naren2024_MMT1-develop-210-gd9db02df
...
export CBIG_CODE_DIR=$HOME/storage/CBIG/CBIG_private
