...
# 
# EXAMPLE: 
#	CBIG_ME_ABCD_Haufe.sh /my_input_dir/HCP/input/ /my_results_dir/HCP/output/ full
...
matlab -nodesktop -nosplash -nodisplay -r " try addpath('$scriptdir'); CBIG_ME_HCP_Haufe( \
