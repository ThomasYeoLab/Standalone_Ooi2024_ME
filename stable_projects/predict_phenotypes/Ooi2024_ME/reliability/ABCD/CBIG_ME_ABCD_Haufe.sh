...
# sample size, type of regression and index of the phenotype.
# 
# EXAMPLE: 
#	CBIG_ME_ABCD_Haufe.sh /my_input_dir/ABCD/input/ /my_results_dir/ABCD/output/ full
#                                "2_mins" "200_subjects" "KRR" 1
#	
...
LF="$output_dir/${reg}_${num_mins}_${num_subs}_behav${behav_num}_interpretation.log"
...
echo "behav_num = $behav_num" >> $LF

### Call matlab function
matlab -nodesktop -nosplash -nodisplay -r " try addpath('$scriptdir'); CBIG_ME_ABCD_Haufe( \
   '$input_dir','$results_dir', '$vers', '$num_mins', '$num_subs', '$reg', $behav_num); catch ME; display(ME.message); \
   end; exit; " >> $LF 2>&1