function CBIG_ME_ABCD_KRR_randomFC_splithalf_subsample(num_sites, ...
    innerFolds, mins, vers, basedir, subtxt, subcsv, ...
    predvar, covtxt, ymat, covmat, ss)
...
%
%   - ss
%     An integer representing the specifc subsample to run the analysis for.
% 
