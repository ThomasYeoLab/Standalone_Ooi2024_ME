...
#
# Example:
# ssh headnode; ${TANNGUYEN2025_BA_DIR}/replication/scripts/ad_classification/CBIG_BA_brainage64D_finetune_ad.sh \
...
TRAINED_AD_DIR="${TANNGUYEN2025_BA_DIR}/replication/output/ad_classification/brainage64D_finetune/997/seed_${seed}"
...
memory="10gb"
walltime="5:00:00"
job_name="brainage64D_finetune_ad"
...
if [[ "$logreg_flag" -eq 1 ]]; then
    ...
    cmd+=" --output_dir ${OUT_DIR} --model_name ${model}; conda deactivate;"
    job_name="brainage64D_finetune_logreg"
    ...
    cmd+=" --trained_model ${TRAINED_MODEL} --task ${task}; conda deactivate;"
    job_name="brainage64D_finetune_pre_logreg"
