...
#
# EXAMPLE: 
#    CBIG_ORSP_calc_HCP_FC.sh /home/leon_ooi/storage/optimal_prediction/replication/HCP/input 58 \
#        full /home/leon_ooi/storage/optimal_prediction/replication/HCP/input/subject_list_792.txt 400
#
...
LF="$log_dir/${mins}mins_FC.log"
if [ -f $LF ]; then rm $LF; fi

### Call matlab function
matlab -nodesktop -nosplash -nodisplay -r " try addpath('$script_dir'); \
    CBIG_ME_calc_HCP_FC( '$sub_txt', $mins, '$vers', $perm_order, $res); catch ME; \
