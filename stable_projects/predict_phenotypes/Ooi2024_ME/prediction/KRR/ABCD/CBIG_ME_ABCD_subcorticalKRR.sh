...
#
# EXAMPLE: 
#    CBIG_ME_ABCD_subcorticalKRR.sh 20 full
#
...
mkdir -p $projectdir/output/${vers}_sc/logs
LF="$projectdir/output/${vers}_sc/logs/${outstem}.log"
...
matlab -nodesktop -nosplash -nodisplay -r " try addpath('$scriptdir'); CBIG_ME_ABCD_subcorticalKRR( \
