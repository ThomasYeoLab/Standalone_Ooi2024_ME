function CBIG_ME_HCP_KRR(outerFolds, innerFolds, seed, mins, vers, ...
...
%sub_samples = [100 120 150 200 300 400 500 600]; % special case for Fig 3
sub_samples = [200 300 400 500 600];
