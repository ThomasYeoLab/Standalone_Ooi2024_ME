function sub_fold = CBIG_ME_LpOCV_split( subject_list, site_csv, ...
    subject_header, site_header, num_leave_out, outdir, delimiter )

% sub_fold = CBIG_ME_LpOCV_split( subject_list, site_csv, ...
%     subject_header, site_header, num_leave_out, outdir, delimiter )
% 
% This function is originally from CBIG_TRBPC_LpOCV_split from 
% Chen and Tam, Nature Communications, 2022 and has not been changed.
