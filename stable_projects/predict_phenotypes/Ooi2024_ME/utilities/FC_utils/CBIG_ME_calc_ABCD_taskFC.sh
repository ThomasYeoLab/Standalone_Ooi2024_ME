...
#
# EXAMPLE: 
#    CBIG_ME_calc_ABCD_taskFC.sh /home/leon_ooi/storage/optimal_prediction/replication/ABCD/input 20 \
#        full /home/leon_ooi/storage/optimal_prediction/replication/ABCD/input/subject_list_2565.txt 1 MID
#
...
matlab -nodesktop -nosplash -nodisplay -r " try addpath('$script_dir'); \
    CBIG_ME_calc_ABCD_taskFC( '$sub_txt', $mins, '$vers', $perm_order, $batch, '$task'); catch ME; \
