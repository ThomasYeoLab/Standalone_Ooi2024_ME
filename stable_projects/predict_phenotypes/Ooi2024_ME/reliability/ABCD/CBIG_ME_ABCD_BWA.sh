...
# 
# EXAMPLE: 
#	CBIG_ME_ABCD_BWA.sh /my_input_dir/ABCD/input/ /my_results_dir/ABCD/output/ full
...
matlab -nodesktop -nosplash -nodisplay -r " try addpath('$scriptdir'); CBIG_ME_ABCD_BWA( \
